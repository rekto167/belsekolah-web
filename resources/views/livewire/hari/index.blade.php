<div class="mt-3">
    @if(Session::has('message'))
        <div class="bg-green-500 p-2 text-white mb-3 flex" wire:click="deleteSession">
            <div class="row">
    ...
    <table class="border-collapse border border-slate-500">
        ...
        @foreach($days as $day)
            <tr>
                ...
                <td class="border border-slate-700 p-2">{{$day->name}}</td>
                <td class="border border-slate-700 p-2">
                    <button type="button" class="bg-red-500 p-2 text-white" wire:click="deleteIt({{$day->id}})">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <button type="button" class="bg-green-500 p-2 text-white" wire:click="openModalEdit({{$day->id}})">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="relative z-99 @if ($showModalEdit) hidden @endif" aria-labelledby="modal-title"
                        ...
                        <div class="fixed inset-0 z-10 overflow-y-auto">
                            <div
                                ...
                                <form wire:submit.prevent="editDay({{$day->id}})">
                                    <div
                                    ...
                                    <span
                                        ...
                                        Nama Hari
                                                    ...
                                                    <input type="text" wire:model="nameDtl"
